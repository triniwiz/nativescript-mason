...
declare class NSObject implements NSObjectProtocol {
	...
	mason_appendWithNodes(nodes: NSArray<MasonNode> | MasonNode[]): void;

	mason_appendWithText(text: string): void;

	mason_appendWithTexts(texts: NSArray<string> | string[]): void;

	mason_attachAndApply(): void;

	mason_compute(): void;

	mason_computeMaxContent(): void;

	mason_computeMinContent(): void;

	mason_computeWithMaxContent(): void;

	mason_computeWithMinContent(): void;

	mason_computeWithSize(width: number, height: number): void;

	mason_computeWithViewSize(): void;

	mason_computeWithViewSizeWithLayout(layout: boolean): void;

	mason_computeWithWidthHeight(width: number, height: number): void;
	...
	mason_prependWithNodes(nodes: NSArray<MasonNode> | MasonNode[]): void;
