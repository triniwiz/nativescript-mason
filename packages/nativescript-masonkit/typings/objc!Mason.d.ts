...
declare class MasonBr extends NSObject implements MasonElementObjc {
...
declare class MasonDimensionRectCompat extends NSObject {
	...
	init(left: MasonDimensionCompat, top: MasonDimensionCompat, right: MasonDimensionCompat, bottom: MasonDimensionCompat): this;
}
...
declare class MasonFileInputEvent extends MasonEvent {
	...
	static alloc(): MasonFileInputEvent; // inherited from NSObject

	static new(): MasonFileInputEvent; // inherited from NSObject

	readonly data: string;

	readonly inputType: string;

	readonly rawData: NSArray<NSURL>;

	constructor(o: { type: string; data: string; inputType: string; options: MasonEventOptions; rawData: NSArray<NSURL> | NSURL[]; });

	initWithTypeDataInputTypeOptionsRawData(type: string, inputData: string, masonInputType: string, options: MasonEventOptions, inputRawData: NSArray<NSURL> | NSURL[]): this;
}
...
declare class MasonInput extends UIView {
	...
	static appearance(): MasonInput; // inherited from UIAppearance

	/**
	 * @since 8.0
	 */
	static appearanceForTraitCollection(trait: UITraitCollection): MasonInput; // inherited from UIAppearance

	/**
	 * @since 8.0
	 * @deprecated 9.0
	 */
	static appearanceForTraitCollectionWhenContainedIn(trait: UITraitCollection, ContainerClass: typeof NSObject): MasonInput; // inherited from UIAppearance

	/**
	 * @since 9.0
	 */
	static appearanceForTraitCollectionWhenContainedInInstancesOfClasses(trait: UITraitCollection, containerTypes: NSArray<typeof NSObject> | typeof NSObject[]): MasonInput; // inherited from UIAppearance

	/**
	 * @since 5.0
	 * @deprecated 9.0
	 */
	static appearanceWhenContainedIn(ContainerClass: typeof NSObject): MasonInput; // inherited from UIAppearance

	/**
	 * @since 9.0
	 */
	static appearanceWhenContainedInInstancesOfClasses(containerTypes: NSArray<typeof NSObject> | typeof NSObject[]): MasonInput; // inherited from UIAppearance
...
declare class MasonLayout extends NSObject {
	...
	readonly border: MasonRectHelper;

	readonly borderBottom: number;

	readonly borderIsEmpty: boolean;
	...
	readonly contentSize: MasonSizeHelper;
	...
	readonly margin: MasonRectHelper;

	readonly marginBottom: number;

	readonly marginIsEmpty: boolean;
	...
	readonly padding: MasonRectHelper;

	readonly paddingBottom: number;

	readonly paddingIsEmpty: boolean;
	...
	readonly scrollbarSize: MasonSizeHelper;
	...
	static readonly empty: MasonLayout;
}
...
declare class MasonLengthPercentageAutoRectCompat extends NSObject {
	...
	init(left: MasonLengthPercentageAutoCompat, top: MasonLengthPercentageAutoCompat, right: MasonLengthPercentageAutoCompat, bottom: MasonLengthPercentageAutoCompat): this;
}
...
declare class MasonList extends UIView implements MasonElementObjc, UICollectionViewDataSource, UICollectionViewDataSourcePrefetching, UICollectionViewDelegateFlowLayout {
	...
	readonly staticItems: NSDictionary<number, MasonLi>;

	staticViews: NSArray<MasonLi>;
	...
	addView(item: MasonLi): void;

	addViewAt(item: MasonLi, index: number): void;
	...
	invalidateSizeCacheAt(index: number): void;
...
declare class MasonNode extends NSObject {
	...
	hasPseudo(state: PseudoState): boolean;
...
declare class MasonRectHelper extends NSObject {
	...
	static alloc(): MasonRectHelper; // inherited from NSObject

	static new(): MasonRectHelper; // inherited from NSObject
...
declare class MasonSizeHelper extends NSObject {

	static alloc(): MasonSizeHelper; // inherited from NSObject

	static new(): MasonSizeHelper; // inherited from NSObject
...
declare class MasonStyle extends NSObject {
	...
	fontVariantNumericString: string;
	...
	setColorWithCss(color: string): void;

	setColorWithUi(color: UIColor): void;

	setColumnGap(value: number, type: number): void;

	setDecorationColorWithCss(color: string): void;
...
declare class MasonVerticalAlignValue extends NSObject {

	static alloc(): MasonVerticalAlignValue; // inherited from NSObject

	static new(): MasonVerticalAlignValue; // inherited from NSObject
}
...
declare class NSCFontDescriptors extends NSObject implements NSMutableCopying {
...
declare class NSCFontFace extends NSObject {
	...
	constructor(o: { family: string; owner: MasonStyle; });
	...
	initWithFamilyOwner(family: string, style: MasonStyle): this;
...
declare const enum PseudoState {
...
declare function mason_node_get_float_rects(mason: interop.Pointer | interop.Reference<any>, node: interop.Pointer | interop.Reference<any>, callback: interop.FunctionReference<(p1: interop.Pointer | interop.Reference<number>) => interop.Pointer | interop.Reference<any>>): interop.Pointer | interop.Reference<any>;

declare function mason_node_get_float_rects_buffer(mason: interop.Pointer | interop.Reference<any>, node: interop.Pointer | interop.Reference<any>): interop.Pointer | interop.Reference<CMasonBuffer>;

declare function mason_node_get_pseudo_states(mason: interop.Pointer | interop.Reference<any>, node: interop.Pointer | interop.Reference<any>): number;
...
declare function mason_node_has_pseudo_state(mason: interop.Pointer | interop.Reference<any>, node: interop.Pointer | interop.Reference<any>, flag: number): boolean;
...
declare function mason_node_release_float_rects_buffer(buffer: interop.Pointer | interop.Reference<CMasonBuffer>): void;
...
declare function mason_node_set_pseudo_states(mason: interop.Pointer | interop.Reference<any>, node: interop.Pointer | interop.Reference<any>, flags: number): void;
