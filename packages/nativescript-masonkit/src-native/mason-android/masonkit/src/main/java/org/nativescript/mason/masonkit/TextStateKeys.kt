...
value class TextStateKeys internal constructor(val bits: Long) {
  companion object {
    ...
    val TEXT_OVERFLOW = TextStateKeys(1L shl 11)
    ...
    val LINE_HEIGHT = TextStateKeys(1L shl 15)
    val VERTICAL_ALIGN = TextStateKeys(1L shl 16)
    val DECORATION_THICKNESS = TextStateKeys(1L shl 17)
    val TEXT_SHADOWS = TextStateKeys(1L shl 18)
    val FONT_FAMILY = TextStateKeys(1L shl 19)
    val LETTER_SPACING = TextStateKeys(1L shl 20)
  }
