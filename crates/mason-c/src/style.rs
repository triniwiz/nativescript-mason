use std::ffi::{c_char, c_float, c_schar, CStr, CString};
...
pub extern "C" fn mason_style_set_with_values(
    ...
    position: c_schar,
    direction: c_schar,
    flex_direction: c_schar,
    flex_wrap: c_schar,
    overflow: c_schar,
    align_items: c_schar,
    align_self: c_schar,
    align_content: c_schar,
    justify_items: c_schar,
    justify_self: c_schar,
    justify_content: c_schar,
    inset_left_type: c_schar,
    inset_left_value: c_float,
    inset_right_type: c_schar,
    inset_right_value: c_float,
    inset_top_type: c_schar,
    inset_top_value: c_float,
    inset_bottom_type: c_schar,
    inset_bottom_value: c_float,
    margin_left_type: c_schar,
    margin_left_value: c_float,
    margin_right_type: c_schar,
    margin_right_value: c_float,
    margin_top_type: c_schar,
    margin_top_value: c_float,
    margin_bottom_type: c_schar,
    margin_bottom_value: c_float,
    padding_left_type: c_schar,
    padding_left_value: c_float,
    padding_right_type: c_schar,
    padding_right_value: c_float,
    padding_top_type: c_schar,
    padding_top_value: c_float,
    padding_bottom_type: c_schar,
    padding_bottom_value: c_float,
    border_left_type: c_schar,
    border_left_value: c_float,
    border_right_type: c_schar,
    border_right_value: c_float,
    border_top_type: c_schar,
    border_top_value: c_float,
    border_bottom_type: c_schar,
    border_bottom_value: c_float,
    flex_grow: c_float,
    flex_shrink: c_float,
    flex_basis_type: c_schar,
    ...
    gap_row_type: c_schar,
    gap_row_value: c_float,
    gap_column_type: c_schar,
    gap_column_value: c_float,
    aspect_ratio: c_float,
    grid_auto_rows: *const c_char,
    grid_auto_columns: *const c_char,
    grid_auto_flow: c_schar,
    grid_column: *const c_char,
    grid_column_start: *const c_char,
    grid_column_end: *const c_char,
    grid_row: *const c_char,
...
#[no_mangle]
pub extern "C" fn mason_style_prepare_style_for_mut(mason: *mut CMason, node: *mut CMasonNode) {
    if mason.is_null() || node.is_null() {
        return;
    }
