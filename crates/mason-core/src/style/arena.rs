...
impl StyleArena {
    pub fn new(default_data: &[u8; STYLE_BUFFER_SIZE]) -> Self {
        ...
        {
            let data = inline.data.as_mut_slice();
            Style::init_default_data(data);
        ...
        {
            let data = flex.data.as_mut_slice();
            Style::init_default_data(data);
            crate::style::utils::set_style_data_i8(
                data,
                StyleKeys::DISPLAY,
        ...
        {
            let data = grid.data.as_mut_slice();
            Style::init_default_data(data);
            crate::style::utils::set_style_data_i8(
                data,
                StyleKeys::DISPLAY,
        ...
        {
            let data = list.data.as_mut_slice();
            Style::init_default_data(data);
        ...
        {
            let data = list_item.data.as_mut_slice();
            Style::init_default_data(data);
            crate::style::utils::set_style_data_i8(
                data,
                StyleKeys::DISPLAY_MODE,
    ...
    fn hash_buffer(data: &[u8; STYLE_BUFFER_SIZE]) -> u64 {
